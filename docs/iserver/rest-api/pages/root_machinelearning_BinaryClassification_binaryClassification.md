...
## URI
<[machinelearning_uri](../machineLearning.htm)>/ml-process:BinaryClassification[.<format>]
## 支持的方法
...
## 资源层次
!\[](../../../../../assets/images/root/machinelearning/BinaryClassification/BinaryClassification.png)[ 
## HTTP 请求方法
...
| outputDatasetName
【可选参数】 | String | 结果数据集名，默认值为binclassify_result。 |
| offset
