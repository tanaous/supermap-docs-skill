...
## URI
<[root_uri](../root.htm#URI)>/{version}/address[.<format>]
## 支持的方法
[GET](#GET 请求)、[HEAD](#HEAD 请求)
## 父资源
[root](../root.htm)
## 子资源
[geocoding](geocoding/geocoding.htm)
[geodecoding](geodecoding/geodecoding.htm)
## 介绍
...
支持的方法：
- [GET](#GET 请求)：获取地址匹配服务支持的子资源列表。
- [HEAD](#HEAD 请求)：检查 address 资源是否存在，或权限是否可以访问 address 资源。
支持的表述格式：RJSON、JSON、HTML、XML。
## 资源层次
!\[](../../../../assets/images/root/address/address.png)[ 
## HTTP 请求方法
...
## 请参见
- [root](../root.htm)，[geocoding](geocoding/geocoding.htm)，[geodecoding](geodecoding/geodecoding.htm)
