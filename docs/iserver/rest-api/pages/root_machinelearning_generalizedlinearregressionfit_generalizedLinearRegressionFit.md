...
## URI
<[machinelearning_uri](../machineLearning.htm)>/ml-process:generalizedlinearregressionfit[.<format>]
## 支持的方法
...
## 资源层次
!\[](../../../../../assets/images/root/machinelearning/generalizedlinearregressionfit/generalizedlinearregressionfit.png)[ 
## HTTP 请求方法
...
### ](generalizedLinearRegressionFit.htm)GET 请求
返回分析的交互操作页面。
### POST 请求
执行分析。
**请求参数**
...
| family 【可选参数】 | String | 模型类型，支持高斯模型“Gaussian”， 逻辑模型“Logistic”， 泊松模型“Poisson”。 |
