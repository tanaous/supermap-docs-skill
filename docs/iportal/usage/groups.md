...
<p class="myNormal">群组是由多个用户所组成的用户集合，通过群组可以汇聚组内成员的资源并进行分享，从而实现组内资源的协同共享，提高组织内部工作效率。</p>
<p class="myNormal">群组由群组创建者进行创建，任一具有 iPortal 创建群组权限的用户均可创建群组。群组的操作主要包括：<a class="contentpagehyperlink" href="groups.htm">创建群组</a>、<a class="contentpagehyperlink" href="groups_join.htm">加入群组</a>、<a class="contentpagehyperlink" href="groups_usage.htm">使用群组</a>等。</p>
<p class="myNormal">作为群组创建者，您还可以<a class="contentpagehyperlink" href="groups_manag.htm">管理您的群组</a>，如进行群组基本信息的设置，解散群组等，以及管理群组资源与成员，如对申请加入群组的用户进行审核，从群组内移除资源及用户等。</p>
<ul class="referenceList">
	<li class="referenceList"><a class="contentpagehyperlink" href="groups.htm">创建群组</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="groups_join.htm">加入群组</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="groups_usage.htm">使用群组</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="groups_manag.htm">管理群组</a></li>
</ul>
<p class="myNormal"> </p>
<p class="myNormal"> </p>
