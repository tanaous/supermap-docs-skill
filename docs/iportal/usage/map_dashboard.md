...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">SuperMap iPortal 提供了地图大屏（MapDashboard） WebApp，它是一款在线制作可视化大屏的应用，可以帮助用户通过图形化的界面，交互式的操作轻松搭建地图可视化应用。</p>
  <p class="myNormal">地图大屏采用拖拽式自由布局，无需编码，全图形化编辑，大屏应用由一个个可视化组件构成，如：地图、场景、图表、指标、文本等，您可以通过<a class="contentpagehyperlink" href="GettingStarted.htm">使用入门</a>快速了解如何创建地图大屏应用。创建地图大屏应用的一般流程包括：<a class="contentpagehyperlink" href="createDashboard.htm">创建项目</a>、<a class="contentpagehyperlink" href="multipageDashboard.htm" title="创建多页面大屏">添加大屏页面</a>、<a class="contentpagehyperlink" href="Add_and_manage_data.htm">添加数据</a>、<a class="contentpagehyperlink" href="add_component/AddComponent.htm">添加可视化组件</a>、<a class="contentpagehyperlink" href="lowcodeEditing.htm">在线低代码编辑</a>等；添加完大屏组件后，您还可以进行<a class="contentpagehyperlink" href="StyleSetting.htm">大屏设置</a>，对大屏进行个性化设置；对于制作完成的大屏，可以进行<a class="contentpagehyperlink" href="preview_and_publish.htm">预览、保存与发布</a>等操作，以实现大屏制作成果的应用。注意：若管理员开启了<a class="contentpagehyperlink" href="../../iportal_management/mapdashboardmanage.htm#MapdashboardsAudit">大屏审核</a>功能，新添加到门户中的大屏审核通过后，才能在门户中搜索与使用。此处我们提供了一个<a class="contentpagehyperlink" href="3DdashboardBuildExamples.htm">基于三维场景的方案汇报大屏实际应用案例</a>，详细介绍如何进行大屏应用的搭建。</p>
  <ul>
    <li class="referenceList"><a class="contentpagehyperlink" href="GettingStarted.htm">使用入门</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="createDashboard.htm">创建项目</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="multipageDashboard.htm">编辑大屏</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="StyleSetting.htm">大屏设置</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="preview_and_publish.htm">预览、保存与发布</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="3DdashboardBuildExamples.htm">基于三维场景的方案汇报大屏实际应用案例</a></li>
  </ul>
  <p class="myNormal"> </p>
  <p class="myNormal"> </p>
