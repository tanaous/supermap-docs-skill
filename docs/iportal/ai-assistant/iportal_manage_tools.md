...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">iPortal管理工具</font>
    </div>
  </div>
  <p>iPortal管理工具，主要提供用户删除、资源数量查询、用户资源迁移等能力</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="iPortalManageTools/UserDelete.htm">用户删除</a>，介绍用户删除的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalManageTools/ResourceQuantityQuery.htm">资源数量查询</a>，介绍资源数量查询的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalManageTools/UserResourceMigration.htm">用户资源迁移</a>，介绍用户资源迁移的操作流程。</li>
  </ul>
  <p> </p>
