...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">邻近分析工具</font>
    </div>
  </div>
  <p>邻近分析工具，主要提供数值型缓冲区分析、字段型缓冲区分析、邻近汇总分析、距离计算分析、邻近查询分析、几何对象邻近查询分析等能力。</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="ProximityAnalysis/NumericBuffersAnalyst.htm">数值型缓冲区分析</a>，介绍数值型缓冲区分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="ProximityAnalysis/FieldBuffersAnalyst.htm">字段型缓冲区分析</a>，介绍字段型缓冲区分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="ProximityAnalysis/SummarizeProximityAnalyst.htm">邻近汇总分析</a>，介绍邻近汇总分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="ProximityAnalysis/ComputeDistanceAnalyst.htm">距离计算分析</a>，介绍距离计算分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="ProximityAnalysis/ProximitySearchAnalyst.htm">邻近查询分析</a>，介绍邻近查询分析的操作流程。</li>
    <!--<li><a class="contentpagehyperlink" href="ProximityAnalysis/ProximitySearchGeometryAnalyst.htm">几何对象邻近查询分析</a>，介绍几何对象邻近查询分析的操作流程。</li>-->
  </ul>
  <p> </p>
