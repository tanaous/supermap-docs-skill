...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">安装指南</font>
    </div>
  </div>
  <p>这里介绍SuperMap iPortal AI助理运行所需要的系统配置要求以及安装部署流程。</p>
  <ul>
    <li><a class="contentpagehyperlink" href="Configuration.htm">系统配置要求</a></li>
    <li><a class="contentpagehyperlink" href="DockerDeployment.htm">Docker方式部署</a></li>
  </ul>
