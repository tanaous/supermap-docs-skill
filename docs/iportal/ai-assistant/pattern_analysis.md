...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">模式分析工具</font>
    </div>
  </div>
  <p>模式分析工具，主要提供创建OD矩阵、密度分析、热点分析、热点格网查找、相似位置筛选等能力</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="PatternAnalysis/CalculateOdMatrix.htm">创建OD矩阵</a>，介绍创建OD矩阵的操作流程。</li>
    <li><a class="contentpagehyperlink" href="PatternAnalysis/DensityAnalyst.htm">密度分析</a>，介绍密度分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="PatternAnalysis/HotspotAnalyst.htm">热点分析</a>，介绍热点分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="PatternAnalysis/HotspotMeshSearch.htm">热点格网查找</a>，介绍热点格网查找的操作流程。</li>
    <li><a class="contentpagehyperlink" href="PatternAnalysis/SearchSimilarLocations.htm">相似位置筛选</a>，介绍相似位置筛选的操作流程。</li>
  </ul>
  <p> </p>
