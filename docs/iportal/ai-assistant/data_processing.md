...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">数据处理工具</font>
    </div>
  </div>
  <p>数据处理工具，主要提供计算凸包分析、几何对象裁剪分析、多几何对象裁剪分析、追加列分析、数据集融合分析、拓扑检查分析、数据追加分析、字段计算分析等能力</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="DataProcessing/ConvexHullAnalyst.htm">计算凸包分析</a>，介绍计算凸包分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/GeoClipAnalyst.htm">几何对象裁剪分析</a>，介绍几何对象裁剪分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/GeosClipAnalyst.htm">多几何对象裁剪分析</a>，介绍多几何对象裁剪分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/AttributeJoinAnalyst.htm">追加列分析</a>，介绍追加列分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/DissolveAnalyst.htm">数据集融合分析</a>，介绍数据集融合分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/TopologyValidateAnalyst.htm">拓扑检查分析</a>，介绍拓扑检查分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/AppendDataAnalyst.htm">数据追加分析</a>，介绍数据追加分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="DataProcessing/CalculateFieldAnalyst.htm">字段计算分析</a>，介绍字段计算分析的操作流程。</li>
  </ul>
  <p> </p>
