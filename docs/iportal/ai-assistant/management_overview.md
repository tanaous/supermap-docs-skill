...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">管理AI助理</font>
    </div>
  </div>
  <p>SuperMap iPortal AI助理为门户管理员提供了工作台，用于工具和知识库的管理。以管理员账户登录后，点击<img height="25" src="Image/Workhouse.png" width="29"/>按钮即可进入工作台，具体请参见：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="ToolSetManagement.htm">工具集管理</a></li>
    <li><a class="contentpagehyperlink" href="ToolManagement.htm">工具管理</a></li>
    <li><a class="contentpagehyperlink" href="MCPManagement.htm">MCP服务管理</a></li>
    <li><a class="contentpagehyperlink" href="KnowledgeBaseManagement.htm">知识库管理</a></li>
  </ul>
