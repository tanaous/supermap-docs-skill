...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">地图可视化工具</font>
    </div>
  </div>
  <p>地图可视化工具，提供地图基础绘制、热力图绘制、单值专题图绘制、分段专题图绘制、3D柱状地图绘制、3D热力图绘制聚合图如绘制、统计图地图绘制、图层叠加、OD地图绘制等工具。</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="Visualization/DrawBasicMap.htm">基础地图绘制</a>，介绍基础地图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawHeatMap.htm">热力图绘制</a>，介绍热力图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawSingleValuedThematicMap.htm">单值专题图绘制</a>，介绍单值专题图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawSegmentedThematicMap.htm">分段专题图绘制</a>，介绍分段专题图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/ResourceLayerStyle.htm">图层叠加</a>，介绍图层叠加的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/Draw3DBarMap.htm">3D柱状地图绘制</a>，介绍3D柱状地图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/Draw3DHeatMap.htm">3D热力图绘制</a>，介绍3D热力图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawAggregateMap.htm">聚合图绘制</a>，介绍聚合图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawChartMap.htm">统计图地图绘制</a>，介绍统计图地图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="Visualization/DrawODMap.htm">OD地图绘制</a>，介绍OD地图绘制的操作流程。</li>
  </ul>
  <p> </p>
