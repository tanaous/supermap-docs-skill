...
<body class="rh-BODY-wrapper">
  ...
  <div class="logoStyle">
    <div class="topicTitle">
      <font face="微软雅黑">iPortal资源工具</font>
    </div>
  </div>
  <p>iPortal资源工具，主要提供最常访问资源查询、用户登录情况查询、资源搜索、资源数据详情探查、资源服务发布、统计分析、统计图绘制等工具。</p>
  <p>本章节介绍如下内容：</p>
  <ul>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/ResourceSearch.htm">资源搜索</a>，介绍资源搜索的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/ResourceExplore.htm">资源数据详情探查</a>，介绍资源数据详情探查的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/PlotStatisticalChart.htm">统计图绘制</a>，介绍统计图绘制的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/StatisticalAnalyst.htm">统计分析</a>，介绍统计分析的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/UserLoginInformationQuery.htm">用户新增情况查询</a>，介绍用户新增情况查询的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/MostFrequentlyVisitedResourceQuery.htm">查询访问量排名</a>，介绍最常访问资源查询的操作流程。</li>
    <li><a class="contentpagehyperlink" href="iPortalSourceTools/ResourcePublish.htm">发布资源服务</a>，介绍资源服务发布的操作流程。</li>
  </ul>
  <p> </p>
