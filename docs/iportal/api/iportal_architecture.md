...
<script type="text/javascript" src="../../assets/js/iportalResourceTree.js"></script>
...
<div class="nav-bar">
	Home &gt;  API参考 &gt;  REST API &gt;  门户资源层次结构 
	 
</div>
<h4>门户资源层次结构</h4>
<p class="myNormal iportal-info">SuperMap iPortal 门户功能的资源层次结构如下：</p>
<div class="tree">
	<p> </p>
</div>
<script type="text/javascript" src="../../assets/js/jquery-1.7.2.min.js"></script>
