...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">SuperMap iPortal 管理员可以对门户中的全部资源进行统一管理。包括对注册服务的管理，进行服务的批量注册，对创建的地图、添加的场景、上传的数据、注册的项目、创建的洞察项目、创建的大屏、创建的应用、创建的群组等进行管理。</p>
  <p class="myNormal">在涉及多级单位或部门的门户应用中，SuperMap iPortal 8C SP2 及以上的版本提供了管理员分级管理模式，通过<a class="contentpagehyperlink" href="Portal_Security/organiz_struc_set.htm">配置组织结构</a>，可以实现管理员分级管理，从而让各级单位或部门管理员在门户中管理各自单位或部门的资源。</p>
  <ul class="referenceList">
    <li class="referenceList"><a class="contentpagehyperlink" href="mapmanage.htm">地图管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="servicesmanage.htm">服务管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="scenes_manage.htm">场景管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="datamanage.htm">数据管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="projectsManage.htm">项目管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="iDataInsights_manager.htm">洞察管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="mapdashboardmanage.htm">大屏管理</a></li>
    <li class="referenceList"><a href="application_manage.htm">应用管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="gpaModel_manage.htm">GPA模型管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="3dDesignmanage.htm">3D设计管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="guoups_manage.htm">群组管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="NotebookMg.htm">Notebook管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="KeyManagemengt.htm">密钥管理</a></li>
  </ul>
