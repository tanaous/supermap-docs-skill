...
<p class="myNormal">SuperMap iPortal 提供了配置与管理 GIS 服务器的能力，门户管理员可以将组织内部的多个 
 SuperMap iServer 服务器添加到门户中进行统一管理与全面监控，保障平台系统安全稳定运行；也可以添加一个数据科学服务器，为在线交互式开发环境<a class="contentpagehyperlink" href="../iportal_usage/add_resource/Notebook.htm"> Notebook</a> 提供运行脚本的能力；还可以在完成<a class="contentpagehyperlink" href="Services_hosting/Storage_Config.htm">托管数据存储配置</a>后，将门户中的一个或多个 
 SuperMap iServer 服务器指定为托管服务器，提供托管服务的能力，拥有 DATA_CENTER 角色的 iPortal 用户可以将其上传至门户中的数据随机分散到这些托管服务器去发布服务（有关数据如何上传至门户，请参阅：<a class="contentpagehyperlink" href="../iportal_usage/add_resource/data.htm">数据</a>。），而无需了解 iServer 
 的任何信息。</p>
<ul class="referenceList">
	<li class="referenceList"><a class="contentpagehyperlink" href="addNode.htm#SuperMap_iServer_服务器">SuperMap_iServer服务器</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="addNode.htm#数据科学服务器">数据科学服务器</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="Services_hosting/hostedServices_config.htm">托管服务器</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="Server_Monitoring/Server_Monitoring.htm">GIS 
	 服务器的监控</a></li>
</ul>
