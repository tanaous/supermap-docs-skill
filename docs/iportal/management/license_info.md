...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">以门户管理员身份登录 SuperMap iPortal 门户首页，点击“管理”模块进入门户管理页面，在“许可”选项卡中可以查看 SuperMap iPortal 当前的许可信息。包括许可状态以及许可的相关附加信息，在附加信息中，会显示 iPortal 当前版本的可注册用户数和已注册用户数。如下图所示：</p>
  <p class="ImageP"><img alt="" border="0" src="../../assets/images/iP/iportal_management/img/license2023.png" style="border: none;"/></p>
  <p class="myNormal">关于 SuperMap iPortal 不同版本的许可信息，请参见：<a class="contentpagehyperlink" href="../iPortal_introduce/ip_version.htm">版本划分</a>。</p>
  <p class="myNormal"> </p>
