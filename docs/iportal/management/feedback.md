...
<p class="myNormal">iPortal 为管理员提供了意见反馈管理功能。普通用户（包括匿名用户）提交反馈后，需经管理员审核，仅审核通过的反馈项会显示在前端页面的反馈列表中供用户查看。管理员可对接收到的反馈进行回复，且只能回复一次。回复支持修改。下面详细介绍反馈管理与审核。</p>
<h2>反馈管理</h2>
<p class="myNormal">登录 iPortal 后，依次点击“管理”&gt;“意见反馈”&gt;“反馈管理”，进入反馈管理页面，管理员即可对门户中接收到的所有反馈项进行统一的管理。管理员可执行以下操作：</p>
<ul style="list-style: disc;" class="SymbolList1">
	<li class="SymbolList1">检索：在搜索框中输入反馈标题的关键字，点击搜索按钮或在键盘上按下回车键，即会搜索并列出与关键字相符的反馈项。对搜索到的结果，您可根据需要执行查看、审核、回复、修改回复、删除等操作。</li>
	<li class="SymbolList1">查看：点击反馈项的标题或在操作栏点击“查看”，可查看反馈项的详细信息，包括：反馈标题、反馈者、邮箱、反馈日期、审核状态、审核意见、反馈内容、回复内容。</li>
	<li class="SymbolList1">审核：“审核状态”为“待审核”的反馈项支持审核操作。可在操作栏点击“审核”，也可在详情页进行“审核”操作。审核结果包括：通过和不通过。审核完成后，审核状态会变更为“审核通过”或“审核不通过”。仅审核通过的反馈项支持回复操作，且会显示在前端页面的反馈列表中供用户查看。</li>
	<li class="SymbolList1">回复：管理员可对审核通过的反馈项执行回复操作。可在操作栏点击“回复”，也可在详情页进行“回复”操作。</li>
	<li class="SymbolList1">修改回复：“回复状态”为“已回复”的反馈项支持修改回复的操作。可在操作栏点击“修改回复”，也可在详情页进行“修改回复”操作。</li>
	<li class="SymbolList1">删除：可在操作栏点击“删除”。也可勾选反馈项标题前的复选框，点击表格上方的“删除”，进行批量删除。</li>
</ul>
<h2>反馈审核</h2>
<p class="myNormal">登录 iPortal 后，依次点击“管理”&gt;“意见反馈”&gt;“反馈审核”，进入反馈审核页面，管理员即可对门户中接收到的所有待审核的反馈项进行审核。审核完成的反馈项不再出现在反馈审核页面。对审核完成的反馈项进行后续操作，需在反馈管理页面进行。反馈审核页面支持以下操作：</p>
<ul style="list-style: disc;" class="SymbolList1">
	<li class="SymbolList1">检索：在搜索框中输入反馈标题的关键字，点击搜索按钮或在键盘上按下回车键，即会搜索并列出与关键字相符的反馈项。对搜索到的结果，您可根据需要执行查看、审核、删除操作。</li>
	<li class="SymbolList1">查看：点击反馈项的标题或在操作栏点击“查看”，可查看反馈项的详细信息，包括：反馈标题、反馈者、邮箱、反馈日期、审核状态、反馈内容。</li>
	<li class="SymbolList1">审核：可在操作栏点击“审核”，也可在详情页进行“审核”操作。审核结果包括：通过和不通过。审核完成后，反馈项不再出现在反馈审核页面，且审核状态会变更为“审核通过”或“审核不通过”。审核通过的反馈项支持回复操作，需在反馈管理界面进行。</li>
	<li class="SymbolList1">删除：可在操作栏点击“删除”。也可勾选反馈项标题前的复选框，点击表格上方的“删除”，进行批量删除。</li>
</ul>
<p class="myNormal"> </p>
