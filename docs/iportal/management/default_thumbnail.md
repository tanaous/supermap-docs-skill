...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">SuperMap iPortal 提供了默认缩略图配置功能，支持对门户中的服务、场景、数据、应用、洞察五类资源的默认缩略图进行自定义配置。您可以根据自身需求，更换各类资源的默认缩略图，一旦配置了默认缩略图，您添加至门户中的资源都会统一使用您配置后的缩略图。当然，您也可以通过编辑单个资源的基本信息来单独配置某个资源的缩略图。</p>
  <p class="myNormal">配置默认缩略图的详细步骤如下：</p>
  <p class="myNormal">以管理员身份登录门户首页，依次选择“管理”<span>&gt;&quot;资源中心配置&quot;&gt;“缩略图配置”</span>，进入默认缩略图配置页面，以配置服务资源的默认缩略图为例：</p>
  <ol class="ListInParagraph" style="list-style: decimal;">
    <li class="ListInParagraph">点击“更换缩略图”按钮</li>
    <li class="ListInParagraph">选择要更新的缩略图文件</li>
    <li class="ListInParagraph">点击“保存”按钮，完成配置</li>
  </ol>
  <p class="myNormal" style="font-weight: bold;">注意：</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">支持上传的缩略图格式为：JPG、PNG</li>
    <li class="SymbolList1">支持上传的图片大小不能超过 1M</li>
    <li class="SymbolList1">建议图片尺寸标准为265 * 170像素</li>
  </ul>
  <p class="myNormal"> </p>
