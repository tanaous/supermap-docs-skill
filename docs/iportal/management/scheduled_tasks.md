...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">以门户管理员身份登录 SuperMap iPortal 门户首页，点击“管理”模块进入门户管理页面，在“计划任务”&gt;&quot;资源定时回收”选项卡下，可以对 SuperMap iPortal 门户软件平台设置资源定时回收，提升门户服务器效率。</p>
  <p class="myNormal">启用资源定时回收后，SuperMap iPortal 门户软件平台会在指定的时间回收临时资源 。当前支持以下两种回收方式：</p>
  <h2 class="myNormal">指定日期</h2>
  <p class="myNormal">设置一个具体的日期和时间点，如 2022-06-11 07:18，iPortal 将在您指定的时间定时回收资源。</p>
  <h2>间隔时间</h2>
  <p class="myNormal">时间间隔可以设置为：</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">每天：设置具体的清理时刻，如 07:18，iPortal 会在每天的 07 时 18 分定时回收资源</li>
    <li class="SymbolList1">每周：选择周内的某一天或多天作为清理时间，并设置具体的清理时刻，如星期一 07 时 18分，iPortal 会在每个星期一的 07 时 18 分定时回收资源</li>
  </ul>
  <p class="SymbolList1"> </p>
  <p class="SymbolList1"> </p>
  <p class="SymbolList1"> </p>
