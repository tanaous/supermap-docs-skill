...
<p class="myNormal">SuperMap iPortal 提供了一系列安全控制的能力用以保障门户安全，管理员可以通过系统安全配置为 
 iPortal 营造一个安全的软硬件环境，还可以通过 Token、Resource Key 等多种身份认证机制对用户注册到门户的 GIS 服务进行保护，此外也提供了一些针对账号安全的保护措施，以及安全信息存储和会话信息管理的方法，您可以根据需要进行相应的安全配置。</p>
<ul class="referenceList">
	<li class="referenceList"><a class="contentpagehyperlink" href="SystemSecurity.htm">系统安全</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="DataSecurity.htm">数据安全</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="AccountSecurity.htm">账号安全</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="../../../Subject_introduce/Security/otherSecurity/storageConfig.htm">安全信息存储</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="../../../Subject_introduce/Security/otherSecurity/sessionConfig.htm">会话信息管理</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="../../../Subject_introduce/Security/systemSecurity/SecurityInfo_Encription.htm">敏感信息加密配置</a></li>
</ul>
