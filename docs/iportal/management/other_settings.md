...
<p class="myNormal">作为 SuperMap iPortal 的管理员，您还可以选择对以下门户功能进行配置，以便更好地满足门户的实际业务需要：</p>
<ul class="referenceList">
	<li class="referenceList"><p><a class="contentpagehyperlink" href="../../Install_Uninstal_iportal/iPortal_config.htm#6.__shareSetting_">资源共享显示用户列表配置</a>：在进行地图、服务、场景等资源的共享设置时，如果选择指定用户分享，您可以设置是否列出所有的 
	 iPortal 用户，方便进行用户的查找。</p></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="../../Install_Uninstal_iportal/iPortal_config.htm#4.__serviceCheckSetting_">服务动态更新时间配置</a>：设置已成功注册的单个服务和批量服务的动态更新时间。</li>
</ul>
<p class="myNormal"> </p>
<p class="myNormal">关于门户更多的配置信息，请参见：<a class="contentpagehyperlink" href="../../Install_Uninstal_iportal/iPortal_config.htm">iPortal 
 配置文件说明</a>。</p>
