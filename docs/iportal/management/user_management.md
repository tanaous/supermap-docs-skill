...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">在 SuperMap iPortal 中，门户管理员有权对内置的账号系统进行配置与管理，如用户的增删、用户注册审核等，还可以通过用户身份识别与授权实现基于角色的访问控制，以保证门户的安全。iPortal 同时也支持集成用户已有的账号系统，并与 iPortal 内的角色进行关联，实现基于角色的访问控制。此外，iPortal 还支持使用基于 OAuth2.0 协议的第三方账户登录，如 QQ、新浪微博、微信。</p>
  <ul class="referenceList">
    <li class="referenceList"><a class="contentpagehyperlink" href="BuiltinAccount.htm">内置账号系统的配置与管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="../iPortal_DevelopGuide/Custom_iPortal/integra_userAccount/integra_userAccount.htm">已有账号系统的集成与管理</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="Portal_Security/third_party_login.htm">配置使用 OAuth2.0 协议的账户</a></li>
  </ul>
