...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">SuperMap iPortal 提供了服务预览视图，可视化展示服务信息。 管理员可以查看服务预览配置的默认底图，添加/删除默认底图，也可对底图的中心点和初始显示级别进行设置。</p>
  <h2>默认底图</h2>
  <p class="myNormal">以管理员身份登录门户首页，依次点击“管理”&gt;“资源中心配置”&gt;“服务预览”，进入服务预览配置页面，选择“默认底图”选项卡，管理员即可查看当前服务预览已配置的底图。</p>
  <h3>添加/删除底图</h3>
  <p class="myNormal">管理员可以在“管理”&gt;“资源中心配置”&gt;“底图配置”中，添加或删除底图，具体请参考：<a class="contentpagehyperlink" href="Basemap_config.htm">底图配置</a></p>
  <h3>调整底图顺序</h3>
  <p class="myNormal">iPortal 提供了底图的排序功能，您可以在底图列表中通过拖动调整底图的顺序，将频繁使用的底图拖到前面，这样在配置服务预览的底图时，就可以在底图列表的第一页中很快找到需要的底图了，调整完顺序后，点击“保存”按钮即可。</p>
  <h2>中心点与显示级别</h2>
  <p class="myNormal">为了更方便直观地对服务进行预览，iPortal  提供了底图的中心点与显示级别的设置功能，使得底图可以显示固定的地理位置和范围大小。iPortal 管理员可以根据自身业务需求，对底图的中心点与显示级别进行配置。</p>
  <p class="myNormal">以管理员身份登录门户首页，依次点击“管理”&gt;“资源中心配置”&gt;“服务预览”，进入服务预览配置页面，选择“中心点与显示级别”选项卡：</p>
  <p class="myNormal">• 底图中心点：设置地图中心点的坐标，仅支持输入 WGS84 坐标</p>
  <p class="myNormal">• 底图初始显示级别：设置地图的初始显示级别，输入范围：0~23。</p>
  <p class="myNormal">设置完成后，点击“保存”按钮，即可生效。</p>
  <p class="myNormal"> </p>
