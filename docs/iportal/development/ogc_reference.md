...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <meta name="rh-index-keywords" content="OGC 服务参考"/>
...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">OGC 服务是 OGC（Open Geospatial Consortium，开放地理信息联盟）制定的一系列 GIS 服务规范，SuperMap iServer 除了提供自身的 GeoREST 服务外，对 OGC 服务也有很好的支持，下面是 SuperMap iServer 中的 OGC 标准服务 API：</p>
  <ul class="referenceList">
    <li class="referenceList"><a class="contentpagehyperlink" href="WMS/WMS_introduce.htm">WMS API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="WMTS/wmts_introduce.htm">WMTS API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="WCS/WCS_Introduction.htm">WCS API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="WFS/WFS_introduce.htm">WFS API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="WPS/WPS_introduce.htm">WPS API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="CSW/CSW_introduce.htm">CSW API</a></li>
  </ul>
  <p class="myNormal">OGC 服务参考的内容覆盖了 SuperMap 三驾马车：SuperMap iPortal、SuperMap iServer 和 SuperMap iEdge。</p>
  <p class="myNormal"> </p>
  <p class="myNormal"> </p>
