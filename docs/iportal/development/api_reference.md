...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <meta name="rh-index-keywords" content="IServer API 参考,API 参考"/>
...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">API 参考的内容覆盖了 SuperMap 三驾马车：SuperMap iPortal、SuperMap iServer 和 SuperMap iEdge。</p>
  <ul class="referenceList">
    <li class="referenceList"><a class="contentpagehyperlink" href="../mergedProjects/iServerJavadoc/overview-summary.html">Javadoc</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="../mergedProjects/SuperMapiServerRESTAPI/Overview.htm">REST API</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="OGC_intro.htm">OGC 服务参考</a></li>
  </ul>
  <p class="myNormal">目前，API 参考中所有的 REST API、OGC 服务都支持<a class="contentpagehyperlink" href="../Subject_introduce/Security/config_role/token/Token.htm">基于 Token 的认证</a>。服务开启安全控制后，访问服务时就需要在请求地址中携带 Token 令牌，具体使用方法可参考<a class="contentpagehyperlink" href="../mergedProjects/SuperMapiServerRESTAPI/Token_RESTServices.htm">基于 Token 访问受保护的 REST 服务资源</a>。</p>
