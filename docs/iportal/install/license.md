...
<meta name="rh-index-keywords" content="许可配置说明"/><meta name="rh-version" content="2022.1.188"/>
...
<p class="myNormal">SuperMap GIS 许可用于验证 SuperMap GIS 产品的可用性，针对 Windows 
 平台，提供 SuperMap 许可中心（SuperMap License Center）对许可进行配置和管理；在 Linux 平台，提供命令行方式配置许可。此外，SuperMap 
 GIS 从 7C 系列产品开始提供<a class="contentpagehyperlink" href="Cloud_license.htm">云许可</a>，从10i版本开始提供 <a class="contentpagehyperlink" href="Web_License.htm">Web 
 许可</a>。</p>
<p class="myNormal">接下来将为您介绍许可的分类与使用，以及如何在 Windows 和 Linux 系统上配置许可。</p>
<ul class="referenceList">
	<li class="referenceList"><p><a class="contentpagehyperlink" href="License_introduce.htm">许可介绍与使用</a></p></li>
	<li class="referenceList"><p><a class="contentpagehyperlink" href="Windows.htm">Windows 系统</a></p></li>
	<li class="referenceList"><p><a class="contentpagehyperlink" href="Linux.htm">Linux 系统</a></p></li>
</ul>
