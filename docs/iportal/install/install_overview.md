...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <meta name="rh-index-keywords" content="安装与卸载"/>
...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">作为跨平台的 GIS 门户软件平台，SuperMap iPortal 支持提供多种平台的多种分发包。目前提供了适用于 Window_x64 操作系统的 zip 包、适用于 Linux_x64 操作系统的 .tar.gz 包以及适用于 Linux_aarch64 操作系统的 .tar.gz包。</p>
  <p class="myNormal">安装前请仔细阅读以下部分内容，保证您的安装环境满足配置要求。您需要先修改防火墙设置，开放 iPortal 使用的端口。配置许可后，再进行安装操作。</p>
  <ul class="referenceList">
    <li class="referenceList"><a class="contentpagehyperlink" href="SystemConfig/SystemConfig.htm">系统配置要求</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="iPortal_port.htm">iPortal 端口介绍</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="License_config/License_Config.htm">许可配置说明</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="Windows_install_uninstall/Windows.htm">在 Windows 系统上安装与卸载</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="Linux_install_uninstall/Linux.htm">在 Linux 系统上安装与卸载</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="Usage_war/Introduction_for_war.htm">war 包使用指南</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="docker.htm">在 Docker 中部署 iPortal</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="Catalog/Catalog_Introduction.htm">安装之后目录说明</a></li>
    <li class="referenceList"><a class="contentpagehyperlink" href="../version_upgrade/version_upgrade.htm">产品升级</a></li>
  </ul>
  <p class="myNormal"> </p>
