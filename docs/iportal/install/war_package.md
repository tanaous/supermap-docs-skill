...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <link rel="stylesheet" type="text/css" href="../../../assets/css/SuperMapHelp.css"/>
...
<body class="rh-BODY-wrapper">
  ...
  <p class="myNormal">SuperMap iPortal 的 war 包可以部署在 Web 服务中间件中，支持的中间件如下表所示。</p>
  <p class="myNormal" style="text-align: center;">表 1：SuperMap iPortal war 包支持的中间件</p>
  ...
  <p class="myNormal">SuperMap iPortal 的 war 包包含如下几部分：</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">iportal.war</li>
  </ul>
  <p class="myNormal">SuperMap iPortal 的核心部分，包含库文件、配置文件、示范数据等信息。使用该 war 包可以获取 SuperMap iPortal 的所有功能。iportal.war 发布后访问的 URI 为：http://{ip}:{port}/iportal。若 iportal.war 被重命名，比如重命名为 renameiportal.war，则访问地址就是 http://{ip}:{port}/renameiportal。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">iportal#help.war</li>
  </ul>
  <p class="myNormal">SuperMap iPortal 的帮助文档和示例代码，使用该 war 包可以将帮助文档发布为在线形式。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1"><span>SuperMap_iPortal_2026_War_Readme_CHS</span>.pdf</li>
  </ul>
  <p class="myNormal">SuperMap iPortal 的自述文件。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">BUILD_*文件</li>
  </ul>
  <p class="myNormal">SuperMap iPortal 的版本（由*的内容标识）。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">licenses</li>
  </ul>
  <p class="myNormal">存放 SuperMap iPortal 用到的开源库的许可协议和声明。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">support_win_x64.zip</li>
  </ul>
  <p class="myNormal">用于Windows x64系统的依赖项，包括JRE、SuperMap许可配置管理工具的安装包等。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">support_linux_x64.tar.gz</li>
  </ul>
  <p class="myNormal">用于Linux x64系统的依赖项，包括JRE等。</p>
  <ul class="SymbolList1" style="list-style: disc;">
    <li class="SymbolList1">support_arm64.tar.gz</li>
  </ul>
  <p class="myNormal">用于ARM 64 系统的依赖项，包括JRE等。</p>
  <p class="myNormal"> </p>
  <p class="myNormal"> </p>
  <p> </p>
  <p class="myNormal"> </p>
