...
<meta name="rh-index-keywords" content="Linux产品卸载,Linux#产品卸载"/><meta name="rh-version" content="2022.1.188"/>
...
<p class="myNormal">SuperMap iPortal（for Linux 系统）目前提供了适用于 Linux_x64操作系统的 
 gzip（GUN zip）压缩属性的 tar 产品包（以.tar.gz 为扩展名）。在 Linux 操作系统上安装和使用 iPortal 时，需要的操作和基本步骤有：</p>
<ul class="referenceList">
	<li class="referenceList"><a class="contentpagehyperlink" href="preConfig.htm">安装前配置</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="install.htm">产品安装</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="postConfig.htm">安装后配置（可选）</a></li>
	<li class="referenceList"><a class="contentpagehyperlink" href="uninstall.htm">产品卸载</a></li>
</ul>
<p class="myNormal"> </p>
