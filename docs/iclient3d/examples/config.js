        ...
        content: {
            "plotting": {
                ...
                content: [
                    ...
                    {
                        name: "标号转json",
                        name_en: "Geometry Convert to Json",
                    ...
                    },
                    {
                        name: "标牌示例",
                        name_en: "Sign Effect",
                        thumbnail: "plot_SignEffect.jpg",
                        fileName: "plot_SignEffect"
                    },
                    {
                        name: "模型单例显示",
                        name_en: "Model Instance",
                ...
                content: [
                    {
                        name: "雷达示例",
                        name_en: "Plot Radar",
                        thumbnail: "plot_Radars.jpg",
                        fileName: "plot_Radars"
                    }
                ]
            }
        }
